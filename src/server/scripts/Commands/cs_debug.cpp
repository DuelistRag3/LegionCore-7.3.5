...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> debugCommandTable =
        {
            ...
            { "arena",          SEC_GAMEMASTER,   false, &HandleDebugArenaCommand,           ""},
            { "attackpower",    SEC_GAMEMASTER,   false, &HandleDebugModifyAttackpowerCommand,    ""},
            { "backward",       SEC_GAMEMASTER,   false, &HandleDebugMoveBackward,           ""},
            { "bg",             SEC_GAMEMASTER,   false, &HandleDebugBattlegroundCommand,    ""},
            { "ashran",         SEC_GAMEMASTER,   false, &HandleDebugAshranCommand,          ""},
            { "lfg",            SEC_GAMEMASTER,   false, &HandleDebugLFGCommand,             ""},
            { "challenge",      SEC_GAMEMASTER,   false, &HandleDebugChallengeCommand,       ""},
            { "crit",           SEC_GAMEMASTER,   false, &HandleDebugModifyCritChanceCommand,     ""},
            ...
            { "haste",          SEC_GAMEMASTER,   false, &HandleDebugModifyHasteCommand,     ""},
            { "hit",            SEC_GAMEMASTER,   false, &HandleDebugModifyHitCommand,       ""},
            { "versality",      SEC_GAMEMASTER,   false, &HandleDebugModifyVersalityCommand, ""},
            { "hostile",        SEC_GAMEMASTER,   false, &HandleDebugHostileRefListCommand,  ""},
            ...
            { "mastery",        SEC_GAMEMASTER,   false, &HandleDebugModifyMasteryCommand,        ""},
            ...
            { "spellpower",     SEC_GAMEMASTER,   false, &HandleDebugModifySpellpowerCommand,     ""},
            ...
            { "challengeloot",  SEC_GAMEMASTER,   false, &HandleDebugChallengeLootCommand,   ""},
            { "group",          SEC_GAMEMASTER,   false, &HandleDebugGroupCommand,           ""},
            { "pvpmystic",      SEC_GAMEMASTER, false, &HandleDebugPvpMysticCommand, ""},
